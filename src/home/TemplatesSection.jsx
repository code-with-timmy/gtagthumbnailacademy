  ...
  return (
    <section className="py-32 relative bg-[#0a0e1a]">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <span className="bg-gradient-to-r from-pink-400 via-purple-400 to-pink-400 bg-clip-text text-transparent max-sm:text-[20px] max-md:text-[20px]">
              ...
              <div className="bg-gradient-to-b from-[#1a1d35] via-[#151828] to-[#0f111f] rounded-[32px] p-8 border border-blue-500/20 shadow-[0_8px_60px_rgba(37,99,235,0.2)]">
                ...
                <div className="relative rounded-[24px] overflow-hidden bg-black mb-7">
                  ...
                  {(idx === 0 || idx === 1) && (
                    <div
                      className={`absolute ${
                        idx === 0 ? "bottom-5 left-5" : "top-5 left-5"
                      } bg-white text-black px-3 py-2.5 rounded-md flex flex-col items-center font-black leading-none shadow-lg`}
                    >
