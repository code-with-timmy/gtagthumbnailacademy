  ...
  return (
    <section className="py-20 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        >
          I've created hundreds of thumbnails for hundreds of creators, across dozens of niches on YouTube. 
          Through that experience, I've learned the formula behind generating millions of views.
        </motion.p>
          ...
          <div className="flex animate-scroll">
            {doubledCreators.map((creator, idx) => (
              ...
              >
                ...
                <span className="text-base font-bold text-white">{creator.name}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      >
        ...
        <span className="text-sm font-medium hidden sm:inline">Join Discord!</span>
      </a>
    </section>
  );
}